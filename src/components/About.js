...
export default function About({ mode }) {
    ...
    return (
        <Container className="d-flex flex-column align-items-center" style={{ maxWidth: '700px', marginTop: '2rem' }}>
            <h1 className="my-3">README.md</h1>
            <div className={`accordion ${accordionClass} w-100`} id="accordionExample">
            ...
            {/* Centered image below accordion */}
            <div style={{ marginTop: '2rem', textAlign: 'center' }}>
                <img
                    src={field}
                    alt="flowers"
                    style={{ maxWidth: '100%', height: '180px', objectFit: 'contain' }}
                />
            </div>
        </Container>
    );
